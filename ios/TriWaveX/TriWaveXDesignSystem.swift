...
enum TriWaveXMotion {
    ...
    static let loginTitleLiftDurationMilliseconds = 1_350
    static let loginTitleLift = Animation.timingCurve(
        0.23,
        1,
        0.32,
        1,
        duration: Double(loginTitleLiftDurationMilliseconds) / 1_000
    )
