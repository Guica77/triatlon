  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-text-primary flex flex-col items-center justify-center p-4 selection:bg-sport-swim/20">
      ...
      <ProCard className="w-full max-w-md p-8 text-center space-y-6 bg-bg-app/40 border-border-default/80 backdrop-blur-md">
        <div className="mx-auto w-16 h-16 rounded-full bg-sport-swim/10 border border-sport-swim/20 flex items-center justify-center animate-spin-slow">
          <Compass className="w-8 h-8 text-sport-swim" />
        </div>

        <div className="space-y-2">
          <span className="text-sm font-black text-sport-swim tracking-wider">ERROR 404</span>
