...
export default function SupportPage() {
  ...
  return <main className="mx-auto max-w-2xl px-6 py-16 space-y-6">
    ...
    <h1 className="text-3xl font-bold">Soporte de Triatlón Pro</h1>
    ...
    {email ? <a className="inline-block rounded-xl border px-5 py-3 font-semibold" href={`mailto:${email}?subject=Soporte%20Triatl%C3%B3n%20Pro`}>Escribir a {email}</a>
