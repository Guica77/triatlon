    ...
    >
      <div className="space-y-6 relative z-10">
        <AnimatePresence mode="wait">
          {success ? (
            ...
            >
              ...
              <p className="text-sm text-zinc-300 font-medium">¡Bienvenido教练! Cargando tu panel...</p>
            </motion.div>
          ) : (
            <motion.form
              key="form"
            ...
            >
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="text-[10px] text-amber-500 hover:text-amber-400 transition-colors font-bold uppercase tracking-wider"
                  >
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    required
                    className="w-full bg-zinc-800/50 border border-zinc-700/50 rounded-xl pl-3.5 pr-10 py-3 text-sm text-white placeholder-zinc-600 outline-none focus:border-amber-500/50 transition-all font-mono"
                  />
                  <button
                    type="button"
              ...
              <motion.button
                whileTap={{ scale: 0.98 }}
                className="w-full mt-4 py-3.5 rounded-xl text-sm font-bold text-white bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 transition-all shadow-lg shadow-amber-500/20 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                type="submit"
                disabled={loading}
              >
                {loading ? (
        ...
        <div className="text-center pt-4">
          ...
          >
            ¿No tienes cuenta? <span className="text-amber-500 font-bold">Regístrate aquí</span>
          </button>
        </div>
      </div>
    </AuthLayout>
