      ...
      <div className="space-y-6 relative z-10 overflow-x-hidden w-full pb-24 sm:pb-8">
        ...
        <div className="grid gap-4">
          <button
            ...
            className="group block w-full bg-zinc-50 border border-zinc-200 rounded-xl p-6 transition-all hover:bg-zinc-100/50 hover:border-zinc-300 cursor-pointer"
          >
            <div className="flex flex-col items-center justify-center gap-3">
              <div className="p-3 bg-white border border-zinc-200 rounded-full">
