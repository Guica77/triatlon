...
export default async function AdminDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-app">
      <div className="flex flex-wrap gap-4 px-4 pt-3 text-sm font-semibold text-swim"><Link href="/admin/discounts">Gestionar descuentos</Link><Link href="/admin/race-discounts">Revisar descuentos por carrera</Link><Link href="/admin/reports">Revisar denuncias del chat</Link></div>
