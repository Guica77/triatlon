...
import { X, CheckCircle, Timer, Minus, Plus, Dumbbell, ShieldAlert, Zap, Activity } from 'lucide-react';
...
export function GymTrackerModal({ isOpen, onClose, workoutTitle }: GymTrackerModalProps) {
  ...
  const exercises = [
    { name: 'Sentadilla Búlgara', targetSets: 3, targetReps: 10, lastLift: 24, img: 'https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?auto=format&fit=crop&q=80&w=800' },
    { name: 'Peso Muerto Rumano', targetSets: 3, targetReps: 8, lastLift: 60, img: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&q=80&w=800' },
    { name: 'Dominadas Asistidas', targetSets: 3, targetReps: 12, lastLift: 0, img: 'https://images.unsplash.com/photo-1598971639058-fab3c3109a00?auto=format&fit=crop&q=80&w=800' },
  ];
  ...
  React.useEffect(() => {
    if (isOpen) {
      setWeight(exercises[currentExercise].lastLift);
      setReps(exercises[currentExercise].targetReps);
    }
        ...
        >
          ...
          <div className="p-5 bg-[#121214] border-t border-zinc-800/80 z-20">
            <button 
              ...
              className="w-full py-4.5 bg-purple-600 hover:bg-purple-500 text-white font-black text-base rounded-2xl shadow-[0_0_20px_rgba(147,51,234,0.3)] transition-all flex items-center justify-center gap-2"
            >
