    ...
    <motion.div key="step1" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="space-y-6">
      <ProCard className="space-y-4 bg-white border border-zinc-200">
        ...
        <div className="space-y-4">
          <div>
            <label className="text-xs font-bold text-zinc-400 block mb-2 uppercase tracking-wider">¿Qué carrera estás preparando?</label>
            ...
            {props.activeTab === 'custom' && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <select title="Modalidad" aria-label="Modalidad" value={props.customModality} onChange={e => props.setCustomModality(e.target.value)} className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-4 py-3 text-sm text-zinc-800 focus:bg-white focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 outline-none transition-all">
          ...
          <div className="border-t border-zinc-200 pt-6 space-y-4">
            <label className="text-xs font-bold text-zinc-400 block uppercase tracking-wider flex items-center gap-1.5">
              <Activity className="w-4 h-4 text-cyan-500" /> Tiempo semanal por disciplina (Horas)
            </label>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <div className="space-y-2 bg-zinc-50/50 p-3.5 rounded-xl border border-zinc-200">
                ...
                <input 
                  ...
                  className="w-full h-1 bg-zinc-200 rounded-lg appearance-none cursor-pointer accent-cyan-500"
                />
                <p className="text-[10px] text-zinc-450 font-semibold">Horas rodando en bici</p>
              </div>

              <div className="space-y-2 bg-zinc-50/50 p-3.5 rounded-xl border border-zinc-200">
                <div className="flex justify-between items-center mb-1">
                  <span className="text-xs text-zinc-650 font-semibold flex items-center gap-1.5">
                    <span className="w-2 h-2 rounded-full bg-rose-450" /> Carrera
                  </span>
                ...
                <input 
                  ...
                  className="w-full h-1 bg-zinc-200 rounded-lg appearance-none cursor-pointer accent-cyan-500"
                />
                <p className="text-[10px] text-zinc-450 font-semibold">Horas corriendo a pie</p>
              </div>
            </div>
          </div>
