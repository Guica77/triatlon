          ...
          >
            ...
            >
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-bold text-white">Compartir Logro</h3>
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full flex items-center gap-3 p-3 rounded-xl bg-zinc-800 border border-zinc-700 hover:border-sky-500/30 transition-colors text-sm text-white font-medium"
                >
                ...
                <button
                  onClick={handleCopy}
                  className="w-full flex items-center gap-3 p-3 rounded-xl bg-zinc-800 border border-zinc-700 hover:border-cyan-500/30 transition-colors text-sm text-white font-medium"
                >
