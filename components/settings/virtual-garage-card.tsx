      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm sm:text-base font-bold text-text-primary tracking-tight leading-tight">Garaje Virtual</h3>
          </div>
          <button 
          ...
          {initialGarage.length === 0 ? (
            ...
            <div className="flex flex-wrap gap-2">
              {initialGarage.map(item => {
                ...
                return (
                  <div key={item} className="px-3 py-1.5 rounded-lg bg-surface-hover border border-border-default flex items-center gap-1.5 ">
                    <span className="text-sm">{matched?.icon || '🎒'}</span>
                    <span className="text-xs font-semibold text-text-primary">{matched?.label || item}</span>
                  </div>
                );
              })}
            </div>
        ...
        {isEditing && (
          ...
          >
            ...
            >
              ...
              <h4 className="text-base font-bold text-text-primary mb-4">Editar Garaje</h4>
                ...
                {VIRTUAL_GARAGE_ITEMS.map(item => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSelected && <Check className="w-3.5 h-3.5 shrink-0 text-warning" />}
                    </button>
                  );
                })}
              </div>
